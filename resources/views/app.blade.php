...
<head>
    ...
    {{-- Renkler (dashboard fonksiyonundan) --}}
    @php($c = (array) getSiteColors())

    {{-- JS tarafında da erişmek için --}}
    <script>
    ...
    <style>
        :root{
            ...
            /* LIGHT tokenlar (componentlerin kullanacağı isimler) */
        ...
        /* DARK: base değerlerden otomatik ton üret */
        :root.dark{
            --surface: #0f172a;
    ...
    {{-- Inertia: sayfa bazlı <Head> içeriği --}}
    @inertiaHead
</head>
