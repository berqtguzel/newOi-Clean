...
export default function NotFound() {
    ...
    const is500 =
        url.includes("/500") || props?.status == 500 || props?.status == 503;
    ...
    const text = (key) =>
        page?.[key] || t(`errors.${slug}.${key}`, fallback[key]);
    ...
    const title = loading ? "" : text("title");
    const desc = loading ? "" : page?.content || text("desc");
            ...
            <div className="oi-404-page min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
                ...
                <main className="oi-404__card">
                    <div className="oi-404__content">
                        ...
                        <p className="oi-404__desc">
                            {loading ? "\u00A0" : desc}{" "}
                            {/* Boşluk karakteri bile stabilite sağlar */}
                        </p>
